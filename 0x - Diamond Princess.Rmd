...
#   geom_rect(aes(xmin = Location - 0.4, xmax = Location + 0.4, ymin = dp_expected_final_deaths_per_million_lower, ymax = dp_expected_final_deaths_per_million_upper), alpha = 0.2) +
#   geom_point(aes(x = Location, y = dp_expected_final_deaths_per_million, color = "Prediction")) +
